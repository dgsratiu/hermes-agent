...
COMMAND_REGISTRY: list[CommandDef] = [
    ...
    CommandDef("omega-goal", "Create a proof-gated multi-agent mission", "Session",
               aliases=("omega_goal",),
               args_hint="<outcome> [--deadline text] [--budget-turns n] [--max-workers n] [--dry-run]"),
    CommandDef("omega", "Inspect or control the active omega mission", "Session",
               args_hint="[status|proof|blockers|stop|promote]",
               subcommands=("status", "proof", "blockers", "stop", "promote")),
